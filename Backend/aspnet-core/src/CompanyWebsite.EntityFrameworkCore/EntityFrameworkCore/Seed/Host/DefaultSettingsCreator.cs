...
namespace CompanyWebsite.EntityFrameworkCore.Seed.Host
{
    public class DefaultSettingsCreator
    {
        ...
        public void Create()
        {
            ...
            AddSettingIfNotExists("CareerRecipientEmailAddresses", "HR@8dge.com.my", tenantId);
            AddSettingIfNotExists("ContactUsRecipientEmailAddresses", "info@8dge.com.my", tenantId);
